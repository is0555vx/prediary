...
schedules = [
    ...
    ("20241106", "2000", "西宮駅", 34.737, 135.341, True, 2),
    ("20241106", "2000", "西宮駅", 34.737, 135.341, True, 1),
    ("20241106", "2000", "西宮駅", 34.737, 135.341, True, 1),
    ('20241122', '1700', '高槻駅', 34.843, 135.617, 1, 3),
    ('20241123', '1100', '茨木駅', 34.813, 135.568, 1, 1),
    ('20241123', '1200', '茨木駅', 34.813, 135.568, 1, 2),
    ('20241123', '1300', '茨木駅', 34.813, 135.568, 1, 3),
    ('20241124', '1900', '西宮駅', 34.737, 135.341, 1, 1),
    ('20241124', '2000', '西宮駅', 34.737, 135.341, 1, 2),
    ('20241124', '2100', '西宮駅', 34.737, 135.341, 1, 3),
